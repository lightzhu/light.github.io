...
;(function(a, b) {
    ...
    for (; e < 4; e += 2)
      c === 'margin' && (f += p.css(a, c + bU[e], !0)),
        d
          ...
          : ((f += parseFloat(bH(a, 'padding' + bU[e])) || 0), c !== 'padding' && (f += parseFloat(bH(a, 'border' + bU[e] + 'Width')) || 0))
    return f
  }
  function ca(a, b, c) {
    ...
    c.queue ||
      ...
      a.nodeType === 1 &&
        ...
        p.css(a, 'display') === 'inline' &&
          p.css(a, 'float') === 'none' &&
          (!p.support.inlineBlockNeedsLayout || cb(a.nodeName) === 'inline' ? (m.display = 'inline-block') : (m.zoom = 1))),
      c.overflow &&
        ((m.overflow = 'hidden'),
  ...
  p.extend({
    ...
    p.extend({
      queue: function(a, b, c) {
        ...
        if (a)
          return (
            (b = (b || 'fx') + 'queue'), (d = p._data(a, b)), c && (!d || p.isArray(c) ? (d = p._data(a, b, p.makeArray(c))) : d.push(c)), d || []
          )
      },
    ...
    (function(a, b) {
      ...
      function bf(a, c, d, e, f) {
        ...
        for (; p < q; p++) {
          ...
          k
            ? ((j = j.concat(k)), (m = a.slice(i)) && m !== ')' ? (B.test(m) ? bd(m, j, d, e) : Z(m, c, d, e ? e.concat(k) : k)) : o.apply(d, j))
            : Z(a, c, d, e)
        }
      ...
      var c,
        ...
        X = T(function(a) {
          return (
            (a.innerHTML = "<a href='#'></a>"), a.firstChild && typeof a.firstChild.getAttribute !== j && a.firstChild.getAttribute('href') === '#'
          )
        }),
        Y = T(function(a) {
          return (
        ...
        $ = (Z.selectors = {
          ...
          preFilter: {
            ATTR: function(a) {
              return (
                (a[1] = a[1].replace(K, '')), (a[3] = (a[4] || a[5] || '').replace(K, '')), a[2] === '~=' && (a[3] = ' ' + a[3] + ' '), a.slice(0, 4)
              )
            },
            CHILD: function(a) {
              return (
            ...
            PSEUDO: function(a) {
              ...
              return L.CHILD.test(a[0])
                ? null
                : (c && (b = D.exec(c)) && b.pop() && ((a[0] = a[0].slice(0, b[0].length - c.length - 1)), (c = b[0].slice(0, -1))),
                  a.splice(2, 3, c || a[3]),
                  a)
            }
          },
          filter: {
            ...
            CLASS: function(a) {
              var b = M[a]
              return (
                b || ((b = M[a] = new RegExp('(^|' + r + ')' + a + '(' + r + '|$)')), N.push(a), N.length > $.cacheLength && delete M[N.shift()]),
                function(a) {
          ...
          pseudos: {
            ...
            text: function(a) {
              var b, c
              return (
                a.nodeName.toLowerCase() === 'input' && (b = a.type) === 'text' && ((c = a.getAttribute('type')) == null || c.toLowerCase() === b)
              )
            },
            radio: R('radio'),
            checkbox: R('checkbox'),
  ...
  p.fn.extend({
    ...
    is: function(a) {
      return (
        !!a &&
        (typeof a == 'string' ? (bf.test(a) ? p(a, this.context).index(this[0]) >= 0 : p.filter(a, this).length > 0) : this.filter(a).length > 0)
      )
    },
            ...
            if (!p.nodeName(h, 'script') || !q(h))
              c.appendChild(h),
                typeof h.getElementsByTagName != 'undefined' &&
                  ((r = p.grep(p.merge([], h.getElementsByTagName('script')), q)), t.splice.apply(t, [s + 1, 0].concat(r)), (s += r.length))
        }
        return t
      },
  ...
  ;(cj = cs.exec(ci.toLowerCase()) || []),
    ...
    p.extend({
      ...
      ajaxSettings: {
        ...
        processData: !0,
        async: !0,
        accepts: { xml: 'application/xml, text/xml', html: 'text/html', text: 'text/plain', json: 'application/json, text/javascript', '*': cw },
      ...
      ajax: function(a, c) {
        function y(a, c, f, i) {
          ...
          if ((a >= 200 && a < 300) || a === 304)
            l.ifModified &&
              ((w = x.getResponseHeader('Last-Modified')), w && (p.lastModified[d] = w), (w = x.getResponseHeader('Etag')), w && (p.etag[d] = w)),
        ...
        o.promise(x),
          ...
          l.crossDomain == null &&
            ...
            (l.crossDomain = !(
              !i ||
              (i[1] == cj[1] && i[2] == cj[2] && (i[3] || (i[1] === 'http:' ? 80 : 443)) == (cj[3] || (cj[1] === 'http:' ? 80 : 443)))
            ))),
            ...
            send: function(e, f) {
              ...
              i.send((c.hasContent && c.data) || null),
                ...
                c.async
                  ? i.readyState === 4
                    ? setTimeout(d, 0)
                    : ((g = ++cJ), cI && (cH || ((cH = {}), p(a).unload(cI)), (cH[g] = d)), (i.onreadystatechange = d))
                  : d()
            },
            abort: function() {
              d && d(0, 1)
